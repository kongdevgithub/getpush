...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientProfile.email_unsubscribed'
        db.add_column(u'clients_clientprofile', 'email_unsubscribed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientProfile.email_unsubscribed'
        db.delete_column(u'clients_clientprofile', 'email_unsubscribed')
    ...
    models = {
        ...
        u'clients.clientprofile': {
            ...
            'email_unsubscribed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'clients.profileconfirmation': {
            'Meta': {'object_name': 'ProfileConfirmation'},
            'confirmation_key': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'confirmed_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number_of_resends': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['clients.ClientProfile']", 'unique': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'})
        },
        u'clients.profileimage': {
