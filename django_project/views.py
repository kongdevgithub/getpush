...
def test(request):
    ...
    return render_to_response('home/thank-start.html')
...
def save(request):
    return render_to_response('home/schedule.html', RequestContext(request))

def schedule(request, id):
    return render_to_response('home/thank-start.html', RequestContext(request))

def schedulesave(request, id):
    return render_to_response('home/thank.html', RequestContext(request))
